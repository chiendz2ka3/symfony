...
class Offer
{
    ...
    /**
     * @var Product
     * @OneToOne(targetEntity="App\Entity\Product")
     ...
     * @ORM\ManyToMany(targetEntity="App\Entity\User", mappedBy="purchases")
     */
    private $buyers;

    /**
     * @var Review[]|ArrayCollection
     * @ORM\OneToMany(targetEntity="App\Entity\Review",mappedBy="offer")
     */
    private $reviews;

    /**
     * @var Promotion[]|ArrayCollection
     * @ORM\OneToMany(targetEntity="App\Entity\Promotion", mappedBy="offer")
     */
    private $promotions;
